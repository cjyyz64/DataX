    ...
    public static class Job extends Writer.Job {
        ...
        public void prepare() {
            ...
            if (tableNumber == 1) {
                ...
                if (originalConfig.getBool(Config.DIRECT_PATH, false) && ObVersion.V4210.compareTo(ObVersion.valueOf(version)) > 0) {
					throw new UnsupportedOperationException("Direct path load only works in oceanbase 4.2.1.0 or newer version.");
                }
        ...
        public List<Configuration> split(int mandatoryNumber) {
			originalConfig.set(Config.BLOCKS_COUNT, mandatoryNumber);
            int tableNumber = originalConfig.getInt(Constant.TABLE_NUMBER_MARK);
            if (tableNumber == 1) {
